...
<%
  ...
  for(int i=0;i<arr1.length;i++){
  	...
  	connObj.update("update vehiclemember set isSelect='0' where travelNo='" + travelNo + "' and vehicleNo='" + vehicleNo + "' and vehicleDetailNo='" + temp01 + "'");
  }
	response.sendRedirect("adminVehicleDetail.jsp?travelNo=" + travelNo + "&travelName=" + URLEncoder.encode(travelName,"UTF-8") + "&vehicleNo=" + vehicleNo);
%>
</body>
</html>
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    al01 = connObj.select("select two,three,four from roomfeedata where travelNo='" + travelNo + "'");
...
<body>
<form name="myForm" action="roomFeeSettingAction.jsp" method="post">
	<div id="page" align="center">
		<div id="content" style="width:800px">
          ...
          out.write("<a href='index.jsp'>首頁</a> | <a href='personalData.jsp'>基本資料維護</a> | <a href='registerPersonalDetail.jsp'>查詢</a>");
			...
			<div id="contenttext01">
				<div style="padding:0px;vertical-align:middle">
					<% out.write("<span class='titletext'>" + travelName + "-房間額外費用設定</span>"); %>
				</div>
          ...
          <table class="FormTable">
            <%
               out.write("<tr>");
               out.write("<td class='FormTDH' style='width:30%'>兩人房</td>");
               out.write("<td class='FormTDC' style='width:70%'><input id='two' name='two' type='text' value='" + arr[0] + "'></td>");
               out.write("</tr>");
               out.write("<td class='FormTDH' style='width:30%'>三人房</td>");
               out.write("<td class='FormTDC' style='width:70%'><input id='three' name='three' type='text' value='" + arr[1] + "'></td>");
               out.write("</tr>");
               out.write("<td class='FormTDH' style='width:30%'>四人房</td>");                
               out.write("<td class='FormTDC' style='width:70%'><input id='four' name='four' type='text' value='" + arr[2] + "'></td>");
               out.write("</tr>");    
            %>
          </table>        
        </div>

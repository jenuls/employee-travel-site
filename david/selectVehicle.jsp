...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script>
		function RedirectTo(vehicleNo){
			window.location.href = "vehicleDetail.jsp?flag=" + document.getElementById("flag").value + "&travelName=" + document.getElementById("travelName").value + "&travelNo=" + document.getElementById("travelNo").value + "&vehicleNo=" + vehicleNo;
		}
    ...
    al01 = connObj.select("select vehicleNo from vehicle where travelNo='" + travelNo + "'");
...
<form name="myForm" action="travelPlanDetailAction.jsp" method="post">
		...
		<div id="content" style="width:800px">
          ...
          out.write("<a href='index.jsp'>首頁</a> | <a href='personalData.jsp'>基本資料維護</a> | <a href='registerPersonalDetail.jsp'>查詢</a>");
			...
			<div id="contenttext01">
				<div style="padding:0px;vertical-align:middle">
					<% out.write("<span class='titletext'>" + travelName + "-車輛清單</span>"); %>
					<br />
				</div>
          ...
          <%
            ...
            for(int i=0;i<al01.size();i++){
              al02 = connObj.select("select MemberName from vehiclemember Where travelNo='" + travelNo + "' and vehicleNo='" + al01.get(i) + "' Order by vehicleDetailNo ASC");
              out.write("<tr>");
	...
	<input id="vehicleNo" type="text" style="display:none" value="">
</form>
</body>
</html>
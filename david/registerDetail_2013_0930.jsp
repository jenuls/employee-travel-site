...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    al01 = connObj.select("SELECT A1.travelName, A2.travelNo, A2.employeeNo, A2.name, A2.money FROM travel A1, registration A2 WHERE (A1.travelNo = A2.travelNo) and A2.isTempFlag ='N' order by A2.travelNo ASC,A2.employeeNo ASC"); 
    for(int i=0;i<al01.size();i++){ String[] arr01 = al01.get(i).split(";"); 
    	if(travelName.equals("")){ travelName = arr01[0]; travelNo = arr01[1]; 
    		employeeNo = arr01[2]; names = arr01[3];    	 travelMoney = arr01[4]; 
    	}else{ 

...
<%
	...
	Collection col = trBean.getJoinDetail(empNo);
		...
		<div id="content" style="width:800px">
            ...
            <div id='menu'>
                ...
                <div id="contenttext01">
                    <div style="padding:0px;vertical-align:middle"><span class="titletext">行程清單</span></div>
        		...
        		<table class="FormTable">
                     ...
                     <tr>
                        ...
                        <td class='FormTDH' style='width:20%;background:#BBBBBB;color:#FFFFFF;padding:3px'>行程名稱</td>
                        <td class='FormTDH' style='width:10%;background:#BBBBBB;color:#FFFFFF;padding:3px'>工號</td>
                        <td class='FormTDH' style='width:10%;background:#BBBBBB;color:#FFFFFF;padding:3px'>姓名</td>
                        <td class='FormTDH' style='width:5%;background:#BBBBBB;color:#FFFFFF;padding:3px'>身份</td>
                        ...
                        <td class='FormTDH' style='width:11%;background:#BBBBBB;color:#FFFFFF;padding:3px'>房間</td>
                        <td class='FormTDH' style='width:11%;background:#BBBBBB;color:#FFFFFF;padding:3px'>餐桌</td>
                        <td class='FormTDH' style='width:13%;background:#BBBBBB;color:#FFFFFF;padding:3px'>車輛</td>
...
%>
                   <tr>
                      ...
                      <td class='FormTDH' style='padding:3px'><%=strUtil.getPara(hm.get("roomNo"))%> 【<%=strUtil.getPara(hm.get("roomDetailNo"))%>】</td>
                      <td class='FormTDH' style='padding:3px'><%=strUtil.getPara(hm.get("deskNo"))%> 【<%=strUtil.getPara(hm.get("deskDetailNo"))%>】</td>
                      <td class='FormTDH' style='padding:3px'><%=strUtil.getPara(hm.get("vehicleNo"))%>【<%=strUtil.getPara(hm.get("vehicleDetailNo"))%>】</td>

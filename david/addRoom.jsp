...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	function returnFn(){
		window.location.href="adminSetSettingList.jsp?travelNo=" + document.forms[0].travelNo.value + "&travelName=" + document.forms[0].travelName.value;			
	}
	</script>
	<title>新增房間</title>
	<%
...
<body>
<form name="myForm" action="addRoomAction.jsp" method="post">
	<div id="page" align="center">
        ...
        <div style="font-size:65%">
          <input type="button" onclick="submitF('T')" value="確定"/>&nbsp;&nbsp;&nbsp;<input type="button" onclick="returnFn()" value="離開"/>
          <br /><br />
        </div>
        <div style="border:1px solid #333333;width:100%"></div>
			</div>

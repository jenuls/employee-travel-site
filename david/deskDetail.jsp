...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script>
		var setsArray = ["N","N","N","N","N","N","N","N","N","N","N"];
		...
		function submitFn(sbumitType){
			...
			if(sbumitType=="S"){
				...
				document.getElementById("returnValue").value = "N;N;N;N;N;N;N;N;N;N;N";
				document.getElementById("returnLuckValue").value = temp2;
			}
    ...
    al01 = connObj.select("select employeeNumber, MemberName from deskmember where travelNo='" + travelNo + "' and deskNo='" + deskNo + "'");
    al02 = connObj.select("select name from registration where employeeNo='" + empNo + "'");
		al03 = connObj.select("select MemberName from deskmember Where travelNo='" + travelNo + "' and deskNo='" + deskNo + "' Order by deskDetailNo ASC");
    ArrayList<String> adminArrList = new ArrayList<String>();
    adminArrList = connObj.select("select EmpNo from admin");
	%>
</head>
<body>
<form name="myForm" action="deskDetailAction.jsp" method="post">

...
<%
  ...
  for(int i=0;i<arr01.length;i++){
  	...
  	if(arr01[i].equals("NA")){
  		connObj.update("update vehiclemember set employeeNumber='NA',MemberName='NA' where travelNo='" + travelNo + "' and vehicleNo='" + vehicleNo + "' and vehicleDetailNo='" + temp + "'");
  	}else if(!arr01[i].equals("N")){
  		connObj.update("update vehiclemember set employeeNumber='" + arr01[i] + "',MemberName='" + arr02[i] + "' where travelNo='" + travelNo + "' and vehicleNo='" + vehicleNo + "' and vehicleDetailNo='" + temp + "'"); 	
  	}
  }

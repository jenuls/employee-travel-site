...
<body>
<form name="myForm" action="addPersonalDataAction.jsp" method="post">
	<div id="page" align="center">
		<div id="content" style="width:800px">
          ...
          <table class="FormTable">
              ...
              <tr>
              <td class='FormTDH' style='width:20%'>工號</td>
              <td class='FormTDH' style='width:30%'><input id='empNo' name='empNo' type='text' style='width:90%' readonly value='<%=empNo%>'></td>
              ...
              <td class='FormTDH' style='width:80%' colspan='3'><input id='birthday' name='birthday' type='text' style='width:90%' value='' readonly></td>
              </tr>
              <tr>
